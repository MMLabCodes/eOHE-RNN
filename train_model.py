...
parser.add_argument('--reduction_type', type=str, choices=[
                    'reduction1', 'reduction2','reduction0'], default='reduction0', help='type of reduction')
...
# set up dataset
if args.selfies:
    dataset = SelfiesDataset(selfies_file=args.smiles_file, reduction_type=args.reduction_type)
else:
    dataset = SmilesDataset(smiles_file=args.smiles_file,
                            vocab_file=args.vocab_file, reduction_type=args.reduction_type)
print('dataset', dataset.vocabulary)
